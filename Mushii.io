  ...
  audio: {
    disableWebAudio: false // Ensure Web Audio API is used for better control
  }
};
...
function preload() {
  ...
  this.load.audio('backgroundMusic', 'https://mushiimushii1.github.io/mushii-wav-hosting/mushii-wav-hosting.wav');
}
